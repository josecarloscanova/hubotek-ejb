...
//TODO: continue the implementation of header values.
//IETF - RFCs 7230, 7231, 7232, 7233, 7234, and 7235. 
//reference httpheaders from spring code.
public enum HttpHeaderEnum {
	...
	static Map<String,HttpHeaderEnum> header_map = new HashMap<String , HttpHeaderEnum>();
	
	static {
		Stream.of(HttpHeaderEnum.values()).forEach( p -> header_map.put(p.value(), p));
	}
	...
	public static HttpHeaderEnum byName(String value)
	{ 
		return Optional.ofNullable(header_map.get(value)).orElse(HttpHeaderEnum.NONE);
	}
